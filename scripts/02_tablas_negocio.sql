-- #####################################################################
-- #  SCRIPT 02: TABLAS DEL ESQUEMA NEGOCIO                           #
-- #  EJECUTAR EN: CONN_NEGOCIO (C##G01_NEGOCIO)                      #
-- #####################################################################
--
-- Contiene las 8 tablas del nucleo operativo. Las claves foraneas
-- hacia el esquema de seguridad (id_usuario_*) se agregan en el
-- script 05 (05_fk_cruzadas.sql), luego de crear las tablas de
-- seguridad, para evitar errores de dependencia.
--
-- NOTA: Las FK internas de negocio (entre tablas de este mismo
-- esquema) se definen aqui, pero las que apuntan a SEGURIDAD se
-- dejan para el script 05.
-- =====================================================================
