-- #####################################################################
-- #  SCRIPT 04: TABLAS DEL ESQUEMA REPORTES                          #
-- #  EJECUTAR EN: CONN_REPORTES (C##G01_REPORTES)                    #
-- #####################################################################
--
-- Contiene la tabla de bitacora de reportes. La FK a t_usuario
-- (seguridad) se agrega en el script 05 (05_fk_cruzadas.sql).
-- =====================================================================
