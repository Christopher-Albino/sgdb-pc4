-- #####################################################################
-- #  SCRIPT 03: TABLAS DEL ESQUEMA SEGURIDAD                         #
-- #  EJECUTAR EN: CONN_SEGURIDAD (C##G01_SEGURIDAD)                  #
-- #####################################################################
--
-- Contiene las 6 tablas de control de acceso y auditoria.
-- Estas tablas NO dependen de negocio, por lo que se crean completas
-- aqui (todas sus FK son internas al propio esquema de seguridad).
-- =====================================================================
